...
# RHNUSERS_MEDIA_ROOT = '/opt/app/django/apps/rhnusers/media/'
JS_PREFIX = os.path.join(MEDIA_ROOT, 'js')
...
# URL prefix for fabrik media
STATIC_MEDIA_PREFIX = '/media/'

# Make this unique, and don't share it with anybody.
SECRET_KEY = 'tyid4f9(&3e3l)@jt68hch-o2lvvnj*k3gy)r5=0hoy5+l7wrh'
